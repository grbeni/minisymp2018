...
communication, and cascade composition is a sequential decomposition of a single function. 
%The introduction of the language elements are supported with simple examples.
\end{abstract}
...
Synchronous components in \gamma\ are synchronous and cascade composite components and statechart definitions.% (described in the GSL).
